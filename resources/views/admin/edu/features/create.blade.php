...
@section('title', 'Edu Features - Cards Admin')
@section('page-title', 'Edu Page - Content Management')

@section('content')
<div class="section-card p-6">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-cards-teal">Features Section - Edu</h2>
        <a href="{{ route('admin.edu.features') }}" class="btn-back">
            <span class="mr-2">←</span>Kembali
        </a>
    </div>

    <form action="{{ route('admin.edu.features.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="flex justify-end space-x-4">
            <a href="{{ route('admin.edu.features') }}" class="btn-secondary">Cancel</a>
