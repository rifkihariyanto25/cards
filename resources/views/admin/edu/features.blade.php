...
@section('title', 'Cards Admin - Features Management')
@section('page-title', 'Edu Page - Features Management')

@section('content')
<div class="section-card p-6">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-semibold text-cards-teal">Features Section</h2>
        <a href="{{ route('admin.edu.features.create') }}" class="btn-add">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form action="{{ route('admin.edu.features.delete', $feature->id ?? 1) }}" 
                              method="POST" 
                              class="inline"
