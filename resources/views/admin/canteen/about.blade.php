...
@section('page-title', 'Cards Canteen - Content Management')

@section('content')
<div class="section-card p-6">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-semibold text-cards-teal">About Section - Canteen</h2>
    </div>

    <form action="{{ route('admin.canteen.about.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
