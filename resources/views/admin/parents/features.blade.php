...
@section('title', 'Cards Admin - Parents Features Management')
@section('page-title', 'Parents Page - Features Management')

@section('content')
<div class="section-card p-6">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-semibold text-cards-teal">Features Section</h2>
        <a href="{{ route('admin.parents.features.create') }}" class="btn-add">
