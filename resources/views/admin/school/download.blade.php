...
@section('page-title', 'Cards School - Content Management')

@section('content')
<div class="section-card p-6">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-semibold text-cards-teal">Download Section - School</h2>
    </div>

    <form action="{{ route('admin.school.download.update') }}" method="POST" enctype="multipart/form-data">
        @csrf
