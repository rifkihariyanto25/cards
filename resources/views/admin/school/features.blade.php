...
@section('title', 'Cards Admin - School Features Management')
@section('page-title', 'School Page - Features Management')

@section('content')
<div class="section-card p-6">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-xl font-semibold text-cards-teal">Features Section</h2>
        <a href="{{ route('admin.school.features.create') }}" class="btn-add">
        ...
        <table class="table-custom">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.school.features.edit', $feature->id ?? 1) }}" 
                           class="action-btn action-btn-edit">
                            <svg class="w-4 h-4 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                            </svg>
                        </a>
                        <form action="{{ route('admin.school.features.delete', $feature->id ?? 1) }}" 
                              method="POST" 
                              class="inline"
