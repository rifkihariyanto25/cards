        ...
        <div class="mt-6">
            ...
            <div class="image-upload-area cursor-pointer border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-gray-400 transition-colors" onclick="document.getElementById('hero-image').click()">
                ...
                <div id="image-preview-container">
                    @if(isset($flexycazhHero->cover_image) && $flexycazhHero->cover_image)
                        <img id="preview-image" src="{{ asset('storage/' . $flexycazhHero->cover_image) }}" alt="Current Image" class="max-w-full max-h-48 rounded-lg mx-auto object-contain">
                        <div class="mt-3">
