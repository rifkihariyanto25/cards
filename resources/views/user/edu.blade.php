...
<head>
    ...
    <title>Cards Edu - Platform Pembelajaran Digital</title>
        ...
        <div class="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-16">
            <div class="text-white animate-slide-up text-center lg:text-left">
                <div class="inline-flex items-center px-4 py-2 bg-white/20 rounded-full text-sm font-medium mb-6 backdrop-blur-sm">
                    <i class="fas fa-rocket mr-2 text-[#f7931e]"></i>
                    Edukasi Digital Terdepan
                </div>
                
                <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6">
                    <span class="gradient-text-white">{{ $heroData->title ?? 'Cards Edu' }}</span>
                </h1>
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <a href="#about" class="group inline-flex items-center justify-center px-8 py-4 bg-[#f7931e] hover:bg-[#db7a00] text-white rounded-2xl font-semibold transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                        <i class="fas fa-info-circle mr-3 group-hover:scale-110 transition-transform"></i>
                        Selengkapnya
                    </a>
                    <a href="#download" class="group inline-flex items-center justify-center px-8 py-4 bg-white/10 hover:bg-white/20 text-white rounded-2xl font-semibold transition-all duration-300 backdrop-blur-sm border border-white/20">
            ...
            <div class="order-1 lg:order-2 flex justify-center">
                <div class="relative w-[400px] h-[350px] animate-fade-in">
                    ...
                    <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 hover-lift">
                        <img src="{{ asset('storage/' . ($heroData->cover_image ?? 'edu/hero/IMG EDU.png')) }}" alt="Cards Edu Mockup" class="w-[280px] h-auto object-contain rounded-3xl shadow-2xl animate-float">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex justify-center">
                <div class="relative w-[400px] h-[350px]">
                    ...
                    <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                        <img src="{{ asset('storage/' . ($aboutData->cover_image ?? 'edu/about/Img About edu.png')) }}" alt="Tentang Cards Edu" class="w-[280px] h-auto object-contain rounded-3xl shadow-2xl hover-lift">
                    </div>
                </div>
            </div>
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <article class="feature-card rounded-2xl p-8 text-center hover-lift shadow-lg hover:shadow-xl transition-all duration-300 reveal">
                    ...
                    <p class="text-gray-600 leading-relaxed">Siswa dan guru dapat melihat jadwal harian langsung dari aplikasi.</p>
                </article>
                <article class="feature-card rounded-2xl p-8 text-center hover-lift shadow-lg hover:shadow-xl transition-all duration-300 reveal">
                    <div class="w-16 h-16 bg-gradient-to-r from-[#007696] to-[#f7931e] rounded-2xl flex items-center justify-center mx-auto mb-6">
                        <i class="fas fa-user-check text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-800 mb-4">Absensi Digital</h3>
                    <p class="text-gray-600 leading-relaxed">Absensi siswa dan guru tercatat secara digital dan dapat dipantau secara real-time.</p>
                </article>
                <article class="feature-card rounded-2xl p-8 text-center hover-lift shadow-lg hover:shadow-xl transition-all duration-300 reveal">
                    <div class="w-16 h-16 bg-gradient-to-r from-[#007696] to-[#f7931e] rounded-2xl flex items-center justify-center mx-auto mb-6">
                        <i class="fas fa-book text-white text-xl"></i>
                    </div>
                    <h3 class="text-xl font-bold text-gray-800 mb-4">Rapor Digital</h3>
                    <p class="text-gray-600 leading-relaxed">Rapor siswa dapat diakses secara digital oleh guru, siswa, dan orang tua.</p>
                </article>
                @endforelse
            </div>
        </div>
            ...
            <div class="flex flex-col lg:flex-row items-center gap-16">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative bg-gradient-to-br from-[#f7931e] to-[#ff6b35] p-8 rounded-[4rem] shadow-2xl max-w-md">
                            <div class="bg-white rounded-[3rem] p-6 shadow-xl">
                                <img src="{{ asset('storage/edu/download.png') }}" alt="Gambar Siswa" class="w-full aspect-square object-cover rounded-[2rem]"/>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full lg:w-1/2 text-center lg:text-left order-1 lg:order-2 space-y-8">
                    <div class="space-y-6">
                        ...
                        <h2 class="text-4xl lg:text-5xl font-bold gradient-text leading-tight">
                            Download Aplikasi<br class="hidden lg:block">Cards Edu
                        </h2>
                        <p class="text-xl text-gray-600 leading-relaxed max-w-2xl">
                            Mulai perjalanan belajar digital Anda sekarang! Download aplikasi Cards Edu dan rasakan pengalaman belajar yang tak terlupakan dengan interface yang modern dan user-friendly.
                        </p>
                    </div>
                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
